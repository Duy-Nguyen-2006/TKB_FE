...
const AIChatModal = ({ isOpen, onClose, onImportData }) => {
    const [messages, setMessages] = useState([
        {
            id: 1,
            role: 'model',
            text: 'Hệ thống sẵn sàng. Vui lòng tải lên ảnh hoặc dán nội dung phân công (Excel, PDF, Text) để tôi trích xuất dữ liệu.',
            data: []
        }
    ]);
    ...
    const handleSend = async () => {
        ...
        const agreementKeywords = ['ok', 'đúng', 'dung', 'chuẩn', 'chuan', 'đồng ý', 'dong y', 'được', 'duoc', 'nhập', 'nhap', 'lưu', 'luu', 'yes'];
